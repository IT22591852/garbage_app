  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.middle}>
        <Text style={styles.content1}>Set Your Weekly Goal</Text>
      </View>
      <Image source={require('../assets/images/weekly-goal.jpg')} style={styles.largeImage} />

      <View style={styles.card}>
        <Text style={styles.content3}>
          Set a weekly garbage collection goal. Choose from preset options or customize your own goal to match your need.
        </Text>
      </View>
